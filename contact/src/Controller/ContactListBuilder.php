...
/**
 * @file
 * Contains \Drupal\contact\Controller\ContentEntityExampleController.
 */
...
/**
 * Provides a list controller for contact entity.
 *
 * @ingroup contact
 */
  ...
  public function render() {
    $build['description'] = array(
      '#markup' => $this->t('Content Entity Example implements a Contacts model. These contacts are fieldable entities. You can manage the fields on the <a href="@adminlink">Contacts admin page</a>.', array(
        '@adminlink' => \Drupal::urlGenerator()->generateFromRoute('contact.contact_settings'),
      )),
    );
